...
import { FaChalkboardTeacher, FaComments, FaTasks, FaQuestionCircle, FaSignOutAlt } from 'react-icons/fa';
    ...
    return (
        ...
        >
            ...
            <button 
                ...
                className="absolute top-6 right-6 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-all shadow-md"
            >
                <FaSignOutAlt />
                <span>Logout</span>
            </button>

            <div className="bg-white bg-opacity-90 p-8 rounded-lg shadow-2xl w-full max-w-2xl text-center transform transition-all hover:scale-105">
